...
#define THUMB_WQVGA_SIZE		1
#define THUMB_QVGA_SIZE			2
#define THUMB_WQQVGA_SIZE		3
#define THUMB_QQVGA_SIZE		4
...
//extern int s3c_fimc_i2c_write(struct i2c_client *client, u8 subaddr, u8 val1,u8 val2,u8 val3);
extern int s3c_fimc_i2c_write(struct i2c_client *client, u8 i2c_data[],u8 length);
