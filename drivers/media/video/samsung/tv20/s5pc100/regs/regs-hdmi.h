...
#define	S5P_HDCP_RX_KSV_1_0			S5P_HDMI_BASE(0x0660)	// Receiver¡¯s KSV 1 0x00
#define	S5P_HDCP_RX_KSV_1_1			S5P_HDMI_BASE(0x0664)	// Receiver¡¯s KSV 1 0x00
...
#define HDMI_STATUS_EN_ALL 	UPDATE_RI_INT_EN|\
				UPDATE_PJ_INT_EN|\
				EXCHANGEKSV_INT_EN|\
				WATCHDOG_INT_EN|\
...
#define   EN_PJ_DIS              (0x0 << 4)
//RESERVED                           3
//#define   TIMEOUT              0x
#define   CP_DESIRED_DIS         (0x1 << 1)
#define   CP_DESIRED_EN          (0x0 << 1)
#define   ENABLE_1_DOT_1_FEATURE_DIS (0x1 << 0)
#define   ENABLE_1_DOT_1_FEATURE_EN  (0x0 << 0)
...
#define   SCRAMBLER_KEY_START_DIS     (0x0 << 7)
...
#define CABLE_PLUGGED    2
#define CABLE_UNPLUGGED  0
